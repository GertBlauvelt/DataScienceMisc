...
ggplot(data = starwars, mapping = aes(x = skin_color, y = eye_color, color = hair_color)) + 
  geom_point()

ggplot(data = starwars, mapping = aes(x = skin_color, y = eye_color)) + 
  geom_point()

ggplot(data=starwars, mapping = aes(y = as.character(starships), x = sex))+
  geom_point()
